...
import { writeFile as _writeFile, mkdir as _mkdir, access as _access, readFileSync } from 'fs'
...
function require(filePath) {
  if(!filePath.endsWith('.json')) throw new Error("require supports only json file");
